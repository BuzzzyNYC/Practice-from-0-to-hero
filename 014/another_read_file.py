'''
Viết chương trình nhập vào từ file input ba số a, b, c. Nếu a, b, c là ba cạnh của một tam giác 
thì kiểm tra và xuất ra file output thông báo loại của tam giác (Có xử lý ngoại lệ đầu vào).
'''
...
try:
   ...
   with open('file_to_read.txt', 'r') as fileInp:
       ...
       dongDauTien = fileInp.readlines().rstrip('\n')
...
with open('file_out.txt', 'w') as fileOut:
